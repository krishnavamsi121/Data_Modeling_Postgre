...
def process_song_file(cur, filepath):
    """
    Process song file and import records to postgres database
    :param cur:
    :param filepath:
    """
    #Open song file
...
def process_log_file(cur,filepath):
    """
    Process Event log files and insert records into Postgres database
    :param cur: cursor reference
    :param filepath: complete filepath for file to load
    """
